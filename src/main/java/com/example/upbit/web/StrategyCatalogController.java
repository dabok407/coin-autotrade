...
public class StrategyCatalogController {
    ...
    private String description(StrategyType t) {
        ...
        switch (t) {
            ...
            case THREE_MARKET_PATTERN:
                return "횡보 구간에서 상/하 이중 가짜돌파(스탑 사냥)가 모두 발생한 뒤, 진짜 신고가 돌파가 나오면 폭발적 상승에 베팅합니다. 양방향 스탑 사냥 완료 = 강한 매수 신호."
                    + "\n\n📊 점수 산출 기준 (기본 5점):"
                    + "\n• 돌파 강도 (+0.3~1.5점): 박스 상단 대비 1.5%+ 초과 돌파"
                    + "\n• 거래량 비율 (+0.3~1.5점): 평균 대비 2배+ 거래량"
                    + "\n• 양봉 강도 (+0~1.0점): 몸통/전체비 70%+ 강한 돌파"
                    + "\n\n■ 권장: 60~240분봉, TP 5~8%, SL 3%";

            case BOLLINGER_SQUEEZE_BREAKOUT:
                return "볼린저 밴드 폭 축소(에너지 축적) → 확장(폭발) + 장대 양봉이 상단 밴드 돌파 + 거래량 급증 시 매수합니다. 10일 이동평균선 이탈 시 청산. 추세 추종의 정석."
                    + "\n\n📊 점수 산출 기준 (기본 5점):"
                    + "\n• 돌파 강도 (+0.3~1.5점): 상단 밴드 대비 1%+ 초과"
                    + "\n• 거래량 비율 (+0.3~1.5점): 평균 대비 2.5배+ 급증"
                    + "\n• 양봉 강도 (+0~1.0점): 몸통/전체비 75%+ 강한 돌파"
                    + "\n• 스퀴즈 깊이 (+0~1.0점): 밴드폭 50%+ 축소 시 강한 압축"
                    + "\n\n■ 권장: 60분봉, 10SMA 자체 청산";

            case TRIANGLE_CONVERGENCE:
                return "삼각수렴(고점 하강 + 저점 상승) 형성 후, 골든타임(2/3 이후)에 장대 양봉 + 2배 거래량으로 상단 추세선 돌파 시 매수합니다. 목표가는 삼각형 밑변 높이만큼."
                    + "\n\n📊 점수 산출 기준 (기본 5점):"
                    + "\n• 돌파 강도 (+0.3~1.5점): 추세선 대비 1.5%+ 초과"
                    + "\n• 거래량 비율 (+0.3~1.5점): 평균 대비 3배+ 급증"
